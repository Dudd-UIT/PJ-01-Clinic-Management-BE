...
class DonThuocController {
  ...
  async fetchDSThuoc(req, res) {
    try {
      const sqlQuery = `
      SELECT distinct CTDT.MACTDT, CTDT.TRANGTHAIDATLICH, th.MATHUOC, TENTHUOC, THANHPHAN, TENDONVI, SOLUONGTHUOC, GIABANLUCKE, SOLANUONG, SOLUONGUONG, GHICHU, hd.MAHD, hd.THANHTIEN, TTTT, TDTT, HOTEN, NGAYLAP
