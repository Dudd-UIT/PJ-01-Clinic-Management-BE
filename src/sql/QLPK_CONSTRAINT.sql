...
ALTER TABLE NHOM_VAITRO ADD CONSTRAINT FK_VAITRO_27 FOREIGN KEY(MAVAITRO) REFERENCES VAITRO(MAVAITRO);
ALTER TABLE PHANCONGKHAM ADD CONSTRAINT FK_PHANCONGKHAM_28 FOREIGN KEY(MABS) REFERENCES BACSI(MABS);
...
ALTER TABLE NHOM_VAITRO DROP CONSTRAINT FK_VAITRO_27;
