...
BEGIN
  ...
  INSERT_HOADON(SEQ15_MAHD.NEXTVAL, 3, NULL, 'ChÆ°a thanh toÃ¡n', 0, NULL, MAHD_OUT => v_MAHDOld);
...
BEGIN
  ...
  VALUES (SEQ18_MACTDT.NEXTVAL, PAR_MADT, PAR_MATHUOC, PAR_SOLANUONG, PAR_SOLUONGUONG, PAR_TRANGTHAI, PAR_SOLUONGTHUOC, PAR_GHICHU);
  ...
  IF VAR_SOLUONGTHUOC > 0 THEN
    RAISE_APPLICATION_ERROR(-20001, 'S? lu?ng thu?c c?n kê vu?t quá s? lu?ng t?n c?a t?t c? các lô trong kho.');
  END IF;
