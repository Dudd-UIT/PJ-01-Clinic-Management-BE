...
AS
BEGIN
  INSERT INTO PHIEUKHAM (MAPK, MABN, MADVK, MABSC, MAPHONG, MAHD, NGAYKHAM, NGAYDATLICH, TRANGTHAITH, STT, HUYETAP, LYDOKHAM, CHIEUCAO, CANNANG, TINHTRANGCOTHE, KETLUAN)
  VALUES (SEQ11_MAPK.NEXTVAL, PAR_MABN, PAR_MADV, PAR_MABS, PAR_MAPHONG, PAR_MAHD, PAR_NGAY_KHAM, PAR_NGAY_DAT_LICH, PAR_TRANGTHAI, PAR_STT, PAR_HUYETAP, PAR_LYDO, PAR_CHIEUCAO, PAR_CANNANG, PAR_TINHTRANG, PAR_KETLUAN);
  COMMIT;
END;


-- THEM PHIEU DANG KY KHAM (UPDATE)
CREATE OR REPLACE PROCEDURE INSERT_PHIEUKHAM_HOADON (
  ...
  PAR_CANNANG PHIEUKHAM.CANNANG%TYPE, PAR_LYDO PHIEUKHAM.LYDOKHAM%TYPE, 
...
BEGIN
  ...
  INSERT INTO PHIEUKHAM (MAPK, MABN, MADVK, MABSC, MAPHONG, MAHD, NGAYKHAM, NGAYDATLICH, 
                         TRANGTHAITH, STT, HUYETAP, LYDOKHAM, CHIEUCAO, CANNANG, 
  ...
  VALUES (SEQ11_MAPK.NEXTVAL, PAR_MABN, PAR_MADV, PAR_MABS, PAR_MAPHONG, v_MAHDOld, 
          ...
          PAR_LYDO, PAR_CHIEUCAO, PAR_CANNANG, PAR_TINHTRANG, PAR_KETLUAN);
  
  COMMIT;
END;


-- TEST INSERT_PHIEUKHAM_BENHNHAN
