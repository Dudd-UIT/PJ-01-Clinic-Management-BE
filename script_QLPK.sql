...
INSERT INTO LOTHUOC (MALOTHUOC, MATHUOC, NHACC, SOLUONGTON, HANSD, GIANHAP, NGAYNHAP, GIABAN) VALUES (5, 4, 'Nhà cung cấp 4', 100, TO_DATE('2025-04-28', 'YYYY-MM-DD'), 7000, TO_DATE('2024-04-21', 'YYYY-MM-DD'), 15000);
INSERT INTO LOTHUOC (MALOTHUOC, MATHUOC, NHACC, SOLUONGTON, HANSD, GIANHAP, NGAYNHAP, GIABAN) VALUES (6, 4, 'Nhà cung cấp 5', 150, TO_DATE('2025-04-30', 'YYYY-MM-DD'), 7000, TO_DATE('2024-04-21', 'YYYY-MM-DD'), 15000);
INSERT INTO LOTHUOC (MALOTHUOC, MATHUOC, NHACC, SOLUONGTON, HANSD, GIANHAP, NGAYNHAP, GIABAN) VALUES (7, 4, 'Nhà cung cấp 5', 150, TO_DATE('2025-04-27', 'YYYY-MM-DD'), 7000, TO_DATE('2024-04-21', 'YYYY-MM-DD'), 15000);
COMMIT;
...
BEFORE UPDATE ON CTDT
FOR EACH ROW
DECLARE 
  VAR_SOLUONGTHUOC_TRUOC NUMBER;
  VAR_SOLUONGTHUOC_SAU NUMBER;
  VAR_SOLUONGTHUOC_THAYDOI NUMBER;
BEGIN
  SELECT SOLUONGTHUOC INTO VAR_SOLUONGTHUOC_TRUOC FROM CTDT WHERE MACTDT = :OLD.MACTDT;

  VAR_SOLUONGTHUOC_SAU := :NEW.SOLUONGTHUOC;

  VAR_SOLUONGTHUOC_THAYDOI := VAR_SOLUONGTHUOC_SAU - VAR_SOLUONGTHUOC_TRUOC;

  IF VAR_SOLUONGTHUOC_THAYDOI <> 0 THEN
    UPDATE LOTHUOC
    SET SOLUONGTON = SOLUONGTON - VAR_SOLUONGTHUOC_THAYDOI
    WHERE MALOTHUOC = (SELECT MALOTHUOC FROM CTDT WHERE MACTDT = :OLD.MACTDT);
  END IF;
END;
/
