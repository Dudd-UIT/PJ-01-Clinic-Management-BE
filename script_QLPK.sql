...
CREATE OR REPLACE TRIGGER TRIGGER_SOBENHNHANTOIDA_BENHNHAN 
...
BEGIN
  ...
  SELECT COUNT(MABN) INTO VAR_SOBENHNHAN
  FROM BENHNHAN
  GROUP BY EXTRACT(DAY FROM );
END;
...
BEGIN
  ...
  INSERT_HOADON(1, 1, NULL, 'Chưa thanh toán', 0, NULL, MAHD_OUT => v_MAHDOld);
...
BEGIN
  ...
  INSERT_HOADON(1, 2, NULL, 'Chưa thanh toán', 0, NULL, MAHD_OUT => v_MAHDOld);
...
BEGIN
  ...
  INSERT_HOADON(1, 3, NULL, 'Chưa thanh toán', 0, NULL, MAHD_OUT => v_MAHDOld);
